...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage({Key ? key,required this.id, required this.name, required this.code,required this.img,required this.price,required this.promotionPrice,required this.size,required this.color}) : super(key: key);
  @override
                ...
                children: <Widget>[
                  ...
                  Flexible(
                                  child: Row(children: <Widget>[
                                    Text(widget.promotionPrice+" Rs",style: TextStyle(
                                      fontSize: 16,height: 1.5
                                    ),),
                                    SizedBox(width: 20,),
                                    Text(widget.price+"Rs",style: TextStyle(
